...
def make_move(player, board) -> None:
    ...
    position = input(player_name(player)+"'s move: ")
    try:
...
def check_win_horizontal(board) -> int:
    ...
    """
    To check whether someone has met a horizontal success.

    Parameter:
        board: list
            The playing board to be checked whether a horizontal win is met.

    Returns:
        int: 
            If a horizontal win is met, id of the winner will be returned;
            If nobody yet has won the game, 0 will be returned.
    """
    if (board[0] != 0 and 
        board[0] == board[1] and 
        board[0] == board[2]):
...
def check_win_vertical(board) -> int :
    # TODO: write docstring
    """
    To check whether someone has met a vertical success.

    Parameter:
        board: list
            The playing board to be checked whether a vertical win is met.

    Returns:
        int: 
            If a vertical win is met, id of the winner will be returned;
            If nobody yet has won the game, 0 will be returned.
    """
    # TODO: implement function
    if (board[0] != 0 and
...
def check_win_diagonal(board)-> int :
    # TODO: write docstring
    """
    To check whether someone has met a diagonal success.

    Parameter:
        board: list
            The playing board to be checked whether a diagonal win is met.

    Returns:
        int: 
            If a diagonal win is met, id of the winner will be returned;
            If nobody yet has won the game, 0 will be returned.
    """
    # TODO: implement function
    if (board[0] != 0 and 
