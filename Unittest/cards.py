...
class Card:
    ...
    def __str__(self):
        return f"{self.rank_name} of {self.suit_name}" # e.g. "Queen of Clubs"
...
class Deck:
    ...
    def __init__(self): 
        ...
        for suit in range(4):
            for rank in range(1,14):
                card = Card(suit,rank)
                self.cards.append(card) # appends in a sorted order, all 52 cards at first.
    ...
    def deal_card(self, i=-1):
        ...
        '''
        return self.cards.pop(i) # cards is a list, pop removes and returns the item at index i
