class Media:
    ...
    def __init__(self, title="No Title", artist="No Artist", releaseDate="No Release Date", url="No URL") -> None:
        """
...
class Track(Media):
    ...
    def __init__(self, title="No Title", artist="No Artist", releaseDate="No Release Date", 
                    url="No URL", album="No Album", genre="No Genre", duration=0) -> None:
        """
...
class Movie(Media):
    ...
    def __init__(self, title="No Title", artist="No Artist", releaseDate="No Release Date", 
                    url="No URL", rating="No Rating", movieLength=0) -> None:
        """
        ...
        super().__init__(title, artist, releaseDate, url)
        self.rating = rating
        self.movieLength = round(movieLength / 60000)
